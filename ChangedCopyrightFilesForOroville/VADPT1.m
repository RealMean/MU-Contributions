VADPT1	;ALB/MRL/MJK,ERC - PATIENT VARIABLES ;7:23 PM  25 Sep 2011
	;;5.3;Registration;**415,489,516,614,688,634**;Aug 13, 1993;Build 7;WorldVistA 30-June-08
	;
...
1	;Demographic [DEM]
	...
	N VWB,VWL
	D BRFAGE^VWTIME(.VWB,DFN),LONGAGE^VWTIME(.VWL,DFN)
	S @VAV@(250000)=VWB_U_VWL
