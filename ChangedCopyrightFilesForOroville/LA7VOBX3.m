LA7VOBX3	;DALOI/JMC - LAB OBX Segment message builder (MI subscripts) cont'd ;Jun 25, 2012
...
ORG	; Organism
	...
	;
	; Check for SNOMED CT coding
	S LA7Y=""
	;S LA7Y=$$IEN2SCT^LA7VSPMA(61.2,LA7X,DT)
	I LA7Y'="" D
	...
	;
	; If no SNOMED CT then use local coding as primary
	I LA7VAL="" D
